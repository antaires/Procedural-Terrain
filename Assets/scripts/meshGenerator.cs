    ...
    public static MeshData GenerateTerrainMesh(float[,] heightMap, float heightMapMultiplier, AnimationCurve heightCurve_, int levelOfDetail)
    {
        ...
        for (int y = 0; y < borderedSize; y+=meshSimplificationIncrement){
            for (int x = 0; x < borderedSize; x+=meshSimplificationIncrement){
                ...
                if (x < borderedSize-1 && y < borderedSize-1){ // ignore right and bottom edges of map
...
public class MeshData{
    ...
    public Mesh CreateMesh(){
        ...
        mesh.uv = uvs;
        mesh.normals = CalculateNormals(); // assure lighting works correctly
        return mesh;
    }
}
